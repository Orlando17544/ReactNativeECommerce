...
const HomeScreen = ({navigation}) => {
	...
	const showAlert = () =>
		Alert.alert(
			"Are you in?",
			"Opting in to notifications will fast-track you to sales as soon as they hit the ASOS app, plus you'll be first to know about hot drops and cool collabs.",
			[
				{ text: "NO THANKS" },
				{ text: "YES PLEASE" }
			]
